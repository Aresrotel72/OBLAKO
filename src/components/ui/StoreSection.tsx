    ...
    <section className="w-full py-24 px-4 bg-background border-t border-border">
      <div className="max-w-5xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          >
            {/* Map provider toggle */}
            <div className="flex items-center gap-2 bg-background-card border border-border rounded-xl p-1 w-fit shadow-sm">
            ...
            {/* Map iframe */}
            <div className="relative h-[300px] rounded-2xl border border-border overflow-hidden bg-background-elevated shadow-sm">
              <iframe
                key={activeMap}
                src={MAPS[activeMap]}
            ...
            <div className="flex gap-2">
              <a
                ...
                className="flex-1 flex items-center justify-center gap-1.5 px-3 py-2.5 rounded-xl text-xs font-semibold text-foreground-secondary border border-border hover:border-[#0071e3]/40 hover:text-[#0071e3] transition-all bg-background-card"
              >
                Открыть в Яндекс
              </a>
              <a
          ...
          >
            {info.map(({ icon: Icon, label, value, sub }, i) => (
              <motion.div
                ...
                className="flex items-start gap-4 bg-background-card border border-border rounded-2xl p-5 shadow-sm"
              >
                ...
                <div>
                  <p className="text-[10px] text-foreground-muted uppercase tracking-widest mb-0.5 font-semibold">{label}</p>
                  <p className="font-bold text-foreground">{value}</p>
                  <p className="text-sm text-foreground-secondary font-light">{sub}</p>
                </div>
              </motion.div>
            ))}

            {/* How to get there */}
            <div className="bg-background-card border border-border rounded-2xl p-5 shadow-sm">
              <p className="text-[10px] text-foreground-muted uppercase tracking-widest mb-3 font-semibold">Как нас найти</p>
            ...
            <div className="flex gap-3 mt-1">
              <div className="flex-1 flex items-center justify-center gap-2 bg-background-card border border-border rounded-2xl py-3.5 text-sm font-semibold text-foreground-muted cursor-not-allowed select-none">
